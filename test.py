...
class WeCareAuthScript(object):
    def __init__(self, proxy_host = 'localhost', proxy_port = '8090', target = 'http://localhost:3000'):
    ...
    def run_script(self):
        ...
        driver.find_element_by_name("email").send_keys('admin@metacorp.com')
        time.sleep(3)
        driver.find_element_by_name("password").clear()
        driver.find_element_by_name("password").send_keys("admin1234")
        time.sleep(3)
